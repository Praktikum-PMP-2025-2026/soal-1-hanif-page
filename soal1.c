...
//  Catatan: Kode ini merupakan versi ke-2 dari kode, yaitu dengan menggunakan pointer pada deklarasi variabel.

 #include <stdio.h>
 #include <string.h>
  
 int main(void) {
    int *izin, *suhu, *radiasi, *jam; // memberikan deklarasi pointer variabel yang akan digunakan.

    scanf("%d %d %d %d", izin, suhu, radiasi, jam); // menerima input dari user dengan pass variabel masukkan input ke pointer variabel.
